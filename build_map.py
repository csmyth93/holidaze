...
<body>
    ...
    <script>
        ...
        function updateAllFavoriteUI() {{
            ...
            if (totalCount > 0) {{
                favMapBtn.innerHTML = '♥<span class="fav-count">' + totalCount + '</span>';
            }} else {{
                favMapBtn.innerHTML = '♡';
            }}
        }}
        ...
        const categoryIcons = {{ attractions: '📍', dinner: '🍽️', lunch: '🥗', bars: '🍸', diving: '🤿' }};
        ...
        function renderFavoritesPanel() {{
            ...
            if (totalCount > 0) {{
                ...
                favMapBtn.innerHTML = '♥<span class="fav-count" id="favCount">' + totalCount + '</span>';
            }} else {{
                favMapBtn.innerHTML = '♡';
            }}
                ...
                items.forEach(item => {{
                    ...
                    html += `
                        <div class="fav-panel-item" data-id="${{item.id}}" data-category="${{category}}" data-lat="${{item.lat}}" data-lng="${{item.lng}}">
                            ...
                            <div class="fav-remove" data-id="${{item.id}}" data-category="${{category}}">×</div>
                        </div>
                    `;
                }});
            }});
